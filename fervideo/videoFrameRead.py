...
ap.add_argument("-v", "--fervideo-file", required=True, help="fervideo file in current directory")
ap.add_argument("--frame-step", type=int, default = 10, help="framecount which fervideo frames are predicted")
